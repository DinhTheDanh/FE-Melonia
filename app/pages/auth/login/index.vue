  ...
  >
    ...
    >
      ...
      <template v-if="step === 1">
        ...
        <!-- Email Form -->
        <UForm :state="state" class="w-full space-y-4" @submit="goToPassword">
          <UFormField
          ...
          <UButton
            ...
            block
            size="xl"
            class="rounded-full cursor-pointer font-bold text-white mt-4 hover:scale-105 transition-transform bg-primary-500 hover:bg-primary-400"
      ...
      <template v-else>
        ...
        <div class="w-full mb-6">
          <button
            class="flex items-center gap-1 text-neutral-400 hover:text-white transition-colors cursor-pointer mb-6"
            @click="step = 1"
          >
            <UIcon name="i-lucide-chevron-left" class="size-5" />
            <span class="text-sm font-medium">{{ t("auth.login.back") }}</span>
          </button>
